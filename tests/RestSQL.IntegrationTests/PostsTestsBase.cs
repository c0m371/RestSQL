    ...
    where TFixture : class, IDatabaseFixture
{
    ...
    public async Task PostsApi_ReturnsCreatedPosts()
    {
        ...
        Assert.StartsWith("2025-10-25 15:03:04", doc.RootElement[0].GetProperty("creationDate").GetString());
        ...
        Assert.Equal("Async", doc.RootElement[0].GetProperty("tags")[0].ToString());
        Assert.Equal("C#", doc.RootElement[0].GetProperty("tags")[1].ToString());
        ...
        Assert.StartsWith("2025-10-26 16:05:15", doc.RootElement[1].GetProperty("creationDate").GetString());
        ...
        Assert.Equal("Database", doc.RootElement[1].GetProperty("tags")[0].ToString());
        Assert.Equal("PostgreSQL", doc.RootElement[1].GetProperty("tags")[1].ToString());
    }

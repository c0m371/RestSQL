...
public class PostgreSQLTests : IntegrationTestBase<PostgreSQLFixture>
{
    ...
    private async Task CreatePost(string title, string description, DateTime creationDate, string username, params string[] tags)
    {
        var client = Client ?? throw new Xunit.Sdk.XunitException("Client not initialized");
    ...
    private static StringContent CreateStringContent(global::System.Object value)
    {
